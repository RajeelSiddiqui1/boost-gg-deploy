                ...
                <div className="w-[350px] border-r border-white/5 flex flex-col bg-black/20">
                    <div className="p-6 border-b border-white/5 space-y-4">
                        <div className="flex justify-between items-center">
                            <h2 className="text-xl font-black italic uppercase">Messages</h2>
                ...
                <div className="flex-1 flex flex-col bg-black/40">
                    {selectedConversation ? (
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center text-center p-12">
                            ...
                            <h2 className="text-2xl font-black italic uppercase text-white/60 mb-2">Select a Conversation</h2>
