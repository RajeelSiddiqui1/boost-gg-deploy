        ...
        <AdminLayout>
            <div className="p-8 space-y-8 font-['Outfit']">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-3xl font-black italic uppercase tracking-tighter">Pro Applications</h1>
                                        ...
                                        <tr key={app._id} className="hover:bg-white/[0.01] transition-colors group">
                                            ...
                                            <td className="px-8 py-6">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <div className="font-black italic uppercase text-sm tracking-tight">{app.userId?.name || 'Guest Candidate'}</div>
                    ...
                    <div className="bg-[#0A0A0A] border border-white/10 rounded-[48px] p-10 max-w-2xl w-full max-h-[90vh] overflow-y-auto relative shadow-2xl">
                        ...
                        <div className="space-y-8">
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    <h2 className="text-3xl font-black italic uppercase tracking-tighter">Review Application</h2>
                            ...
                            <div className="space-y-4 p-8 bg-white/[0.03] border border-white/5 rounded-[32px]">
                                ...
                                <p className="text-sm text-white/60 leading-relaxed italic">{selectedApp.experienceText || selectedApp.personalStatement}</p>
                            </div>
