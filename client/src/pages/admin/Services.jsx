        ...
        <AdminLayout>
            <div className="space-y-8 relative">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    <div>
                        <h1 className="text-2xl font-black italic text-white uppercase tracking-tighter">Services</h1>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
                        <button
                            ...
                            className="flex items-center justify-center gap-2 bg-gradient-to-br from-purple-600 to-purple-800 text-white px-8 py-4 rounded-2xl font-black uppercase italic tracking-widest text-xs transition-all shadow-lg shadow-purple-500/20"
                        >
                        ...
                        <button
                            ...
                            className="flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 text-white px-8 py-4 rounded-2xl font-black uppercase italic tracking-widest text-xs transition-all border border-white/10"
                        >
                            <Plus className="w-5 h-5" />
                            Legacy Add
                        </button>
                ...
                {bulkDeleteConfirm && ReactDOM.createPortal(
                    <div className="fixed inset-0 bg-black/90 backdrop-blur-md flex items-center justify-center z-[9999] p-4">
                        <div className="bg-[#0A0A0A] border border-white/10 rounded-[40px] p-8 md:p-10 max-w-md w-full text-center relative">
                            ...
                            <h3 className="text-2xl md:text-3xl font-black italic uppercase tracking-tighter text-white mb-4">Final Warning</h3>
                            <p className="text-white/40 font-bold mb-10 italic text-sm">
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <button
                                    ...
                                    className="flex-1 px-8 py-4 bg-white/5 hover:bg-white/10 rounded-2xl font-black uppercase italic tracking-widest text-[10px] transition-all border border-white/5 text-white"
                                >
                                    Cancel
                                </button>
                                <button
                                    onClick={handleBulkDelete}
                                    className="flex-1 px-8 py-4 bg-red-500 hover:bg-red-600 rounded-2xl font-black uppercase italic tracking-widest text-[10px] transition-all shadow-lg shadow-red-500/20 text-white"
                                >
                                    Delete All
                                </button>
                            </div>
