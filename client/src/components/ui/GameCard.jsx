      ...
      <div className="relative z-20 h-full flex flex-col justify-between p-6">
        ...
        <div className="flex items-start gap-4 max-w-[75%]">
          ...
          <div className="pt-1">
            ...
            <p className="text-[10px] font-bold text-white/40 uppercase tracking-[0.15em] mt-1.5 drop-shadow-md">
              {game.category || 'Premium Category'}
            </p>
          </div>
        </div>

        {/* Hot Badge Absolute Positioned */}
        {(game.isHot || game.isFeatured) && (
          <div className="absolute top-6 right-6 flex items-center gap-1.5 bg-gradient-to-r from-orange-500 to-red-600 px-3 py-1.5 rounded-full shadow-[0_0_15px_rgba(249,115,22,0.4)]">
