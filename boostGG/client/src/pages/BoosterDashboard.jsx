    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
            ...
            <div className="relative w-full max-w-[500px] bg-[#0A0A0A] border border-white/10 rounded-[40px] p-10 overflow-hidden">
                ...
                <h3 className="text-2xl font-black italic uppercase text-white mb-2 relative z-10">Request Payout</h3>
                ...
                <div className="p-8 space-y-6 flex-1">
                    ...
                    <div className="flex items-start justify-between gap-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h4 className="text-md font-black uppercase text-white group-hover:text-primary transition-colors leading-tight italic">{service?.title}</h4>
                    ...
                    <div className="flex items-center justify-between pt-2">
                        <div>
                            ...
                            <div className="text-xl font-black italic text-white">{formatPrice(order.boosterEarnings || order.price)}</div>
                        </div>
            ...
            <div className="relative isolate">
                ...
                <div className="space-y-12">
                    ...
                    <div className="min-h-[400px]">
                        {tab === 'work' && (
                            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                <div className="flex items-center justify-between">
                                    <h3 className="text-2xl font-black italic uppercase tracking-tight">Available Assignments</h3>
                                ...
                                {availableOrders.length === 0 ? (
                                    <div className="py-32 flex flex-col items-center justify-center bg-[#0A0A0A] border border-white/5 border-dashed rounded-[40px] text-center space-y-6">
                                        ...
                                        <div>
                                            <h4 className="text-xl font-black italic uppercase text-white/40">Market is quiet</h4>
                        ...
                        {tab === 'active' && (
                            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                <h3 className="text-2xl font-black italic uppercase tracking-tight">Operational Tasks</h3>
                                {activeOrders.length === 0 ? (
                                    <div className="py-24 text-center text-white/20 font-black italic uppercase tracking-widest border border-white/5 rounded-[40px]">
                            ...
                            <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                    <div className="lg:col-span-2 space-y-8">
                                        <h3 className="text-2xl font-black italic uppercase tracking-tight">Financial Overview</h3>
                                        <div className="bg-[#0A0A0A] border border-white/5 rounded-[40px] p-10 relative overflow-hidden">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 relative z-10">
                                                <div className="space-y-1">
                                                    ...
                                                    <h2 className="text-5xl font-black italic text-white flex items-center gap-4">
                                    ...
                                    <div className="space-y-6">
                                        <h3 className="text-lg font-black italic uppercase tracking-tight">System Reliability</h3>
                                    ...
                                    <div className="overflow-x-auto">
                                        <table className="w-full text-left">
                                            ...
                                            <tbody className="divide-y divide-white/5">
                                                {payouts.length === 0 ? (
                                                    <tr><td colSpan="4" className="px-10 py-20 text-center text-white/20 font-black italic">Registry is currently empty</td></tr>
                                                ) : (
                                                    payouts.map(p => (
                                                        <tr key={p._id} className="hover:bg-white/[0.01] transition-colors">
                                                            ...
                                                            <td className="px-10 py-6 text-sm font-black italic text-white flex items-center gap-2">
                        ...
                        {tab === 'assignments' && (
                            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                <h3 className="text-2xl font-black italic uppercase tracking-tight">Content Assignments</h3>
                        ...
                        {tab === 'my_content' && (
                            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                <h3 className="text-2xl font-black italic uppercase tracking-tight">My Published Content</h3>
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {user?.proProfile?.portfolio?.map((item, i) => (
                                        <div key={i} className="bg-[#0A0A0A] border border-white/5 rounded-[32px] overflow-hidden group hover:border-primary/40 transition-all">
                                            ...
                                            <div className="p-6">
                                                <h4 className="font-black italic uppercase text-sm mb-2">{item.title}</h4>
                        ...
                        {tab === 'referrals' && (
                            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                <h3 className="text-2xl font-black italic uppercase tracking-tight">Referral Performance</h3>
                                ...
                                <div className="bg-primary/5 border border-primary/20 rounded-[40px] p-10 flex flex-col md:flex-row items-center justify-between gap-8">
                                    <div>
                                        <h4 className="text-xl font-black italic uppercase tracking-tight mb-2">Your Unique Referral Link</h4>
                        ...
                        {tab === 'promos' && (
                            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                <h3 className="text-2xl font-black italic uppercase tracking-tight">Personal Promo Codes</h3>
                                <div className="py-24 text-center border-2 border-dashed border-white/5 rounded-[40px] space-y-4">
                                    <div className="w-16 h-16 bg-white/5 rounded-full flex items-center justify-center mx-auto">
                        ...
                        {tab === 'history' && (
                            <div className="py-24 text-center text-white/20 font-black italic uppercase tracking-widest border border-white/5 rounded-[40px] animate-in fade-in duration-500">
                ...
                {showProofUpload && (
                    <div className="fixed inset-0 z-[110] flex items-center justify-center p-6">
                        ...
                        <div className="relative w-full max-w-[600px] bg-[#0A0A0A] border border-white/10 rounded-[48px] p-12 overflow-hidden">
                            ...
                            <h3 className="text-3xl font-black italic uppercase text-white mb-2 relative z-10">Proof of Completion</h3>
