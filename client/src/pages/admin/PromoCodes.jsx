...
const PromoCodes = () => {
 ...
 {loading ? (
 <tr><td colSpan="6" className="px-8 py-20 text-center text-white/20 font-black animate-pulse">Loading...</td></tr>
 ) : filteredPromoCodes.length === 0 ? (
 <tr><td colSpan="6" className="px-8 py-20 text-center text-white/20 font-black ">No promo codes found</td></tr>
 ) : (
