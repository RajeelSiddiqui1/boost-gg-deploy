                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-gradient-to-br from-primary/20 to-black border border-primary/30 rounded-[32px] p-8 relative overflow-hidden group">
                                ...
                                <div className="space-y-4 relative z-10">
                                    ...
                                    <h2 className="text-4xl font-black italic text-white flex items-baseline gap-2">
                            ...
                            <div className="bg-[#0A0A0A] border border-white/5 rounded-[32px] p-8 flex items-center justify-between">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-2xl font-black italic text-white">{transactions.length}</p>
                                </div>
                        ...
                        <div className="bg-[#0A0A0A] border border-white/5 rounded-[48px] overflow-hidden">
                            ...
                            <div className="p-4">
                                {transactions.length === 0 ? (
                                    <p className="text-center py-10 text-white/20 font-black italic">No transactions yet</p>
                                ) : (
                                    <div className="space-y-2">
                                        {transactions.map(tx => (
                                            <div key={tx._id} className="flex items-center justify-between p-4 bg-white/[0.01] border border-white/5 rounded-2xl">
                                                ...
                                                <p className={`text-xs font-black italic ${tx.type === 'credit' ? 'text-green-500' : 'text-red-500'}`}>
                        ...
                        <div className="bg-[#0A0A0A] border border-white/5 rounded-[48px] p-10">
                            <div className="flex items-center gap-8 mb-10 pb-10 border-b border-white/5">
                                ...
                                <div className="space-y-1">
                                    <h3 className="text-xl font-black italic uppercase text-white">{user?.name}</h3>
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full text-left">
                                    ...
                                    <tbody className="divide-y divide-white/5">
                                        {loading ? (
                                            <tr><td colSpan="5" className="px-8 py-20 text-center text-white/20 font-black italic animate-pulse">Scanning Vault...</td></tr>
                                        ) : orders.length === 0 ? (
                                            <tr><td colSpan="5" className="px-8 py-20 text-center text-white/20 font-black italic">No orders in your vault</td></tr>
                                        ) : (
                                            orders.map((order) => (
