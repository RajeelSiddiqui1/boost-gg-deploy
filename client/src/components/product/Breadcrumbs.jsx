...
const Breadcrumbs = ({ gameName, categoryName, productName }) => {
 ...
 <button
 onClick={() => navigate(-1)}
 className="flex items-center gap-2 rounded-md bg-white/[0.03] px-5 py-2.5 text-[10px] font-black  tracking-[0.2em] text-white/60 transition-all hover:bg-white/[0.08] hover:text-white active:scale-95 border border-white/5"
 >
 <ChevronLeft size={14} />
 Back
 </button>
