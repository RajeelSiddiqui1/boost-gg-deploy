...
const LayoutBlock = ({ block }) => {
 ...
 case 'heading':
 const Tag = c.tag || 'h2';
 widgetHtml = <Tag style={{ color: c.color, textAlign: c.align, fontSize: c.size, margin: 0 }} className="font-black  tracking-tight">{c.text}</Tag>;
 break;
 case 'text':
 ...
 widgetHtml = <div style={{ textAlign: c.align }}><a href={c.link} style={{ borderRadius: c.radius }} className={`inline-block px-8 py-4 font-black  text-xs tracking-widest transition-all ${btnStyle}`}>{c.text}</a></div>;
 break;
 case 'divider':
 ...
 {c.author && <cite className="block mt-4 text-primary text-xs font-bold  tracking-widest">— {c.author}</cite>}
 </blockquote>;
 break;
 case 'code':
 widgetHtml = <div className="bg-[#0a0a0a] border border-white/10 rounded-xl overflow-hidden shadow-2xl">
 <div className="bg-white/5 py-2 px-4 text-xs font-bold  tracking-widest text-white border-b border-white/10 flex items-center"><Code className="w-3 h-3 mr-2" /> {c.language}</div>
 ...
 case 'paragraph':
 return (
 <p className="text-white text-sm md:text-base lg:text-lg leading-6 md:leading-7 lg:leading-8 mb-6 md:mb-8 font-normal">
 {block.content}
 </p>
 );
 ...
 />
 {block.caption && (
 <p className="text-white text-center mt-2 md:mt-3 text-xs md:text-sm font-medium px-2">
 {block.caption}
 </p>
 )}
 </div>
 ...
 <p className="text-lg md:text-xl font-medium text-white mb-2 md:mb-3 leading-relaxed">
 "{block.content}"
 </p>
 {block.author && (
 <cite className="text-primary text-xs md:text-sm font-bold  tracking-wider block">
 — {block.author}
 </cite>
 )}
 </blockquote>
 ...
 <div className="bg-gray-900/80 px-3 md:px-4 py-2 text-xs font-bold  tracking-wider text-white flex items-center gap-2 border-b border-white/5">
 ...
 <h4 className="text-xs md:text-sm font-bold  tracking-wider text-white">Table of Contents</h4>
 </div>
 ...
 <div>
 {block.title && <h5 className="text-blue-400 font-bold  text-xs md:text-sm tracking-wider mb-1 md:mb-2">{block.title}</h5>}
 <p className="text-white text-sm md:text-base font-medium leading-relaxed">{block.content}</p>
 </div>
 </div>
 </div>
 );
 ...
 <h4 className="text-sm md:text-base font-bold  tracking-wide text-white mb-3 md:mb-4 flex items-center gap-2">
 ...
 <th key={i} className="px-3 md:px-4 py-2 md:py-3 text-left text-xs font-bold  tracking-wider text-white/60 border-b border-white/10">{header.trim()}</th>
 ))}
 </tr>
 </thead>
 <tbody>
 ...
 {block.leftContent ? (
 <p className="text-white text-sm md:text-base leading-relaxed">{block.leftContent}</p>
 ) : (
 <p className="text-white text-center text-sm">Left Column Content</p>
 )}
 </div>
 <div className="p-4 md:p-6 bg-white/5 rounded-xl border border-white/10">
 {block.rightContent ? (
 <p className="text-white text-sm md:text-base leading-relaxed">{block.rightContent}</p>
 ) : (
 <p className="text-white text-center text-sm">Right Column Content</p>
 )}
 </div>
 </div>
 );
 ...
 <a
 href={block.url || '#'}
 className={`inline-block px-8 py-4 rounded-xl font-black  text-sm tracking-widest transition-all ${buttonStyles[block.buttonStyle] || buttonStyles.primary}`}
 >
 ...
 {isExpanded && (
 <div className="p-4 md:p-5 text-white text-sm md:text-base bg-black/20">
 ...
 <p className="text-white text-center text-sm">Left Column</p>
 )}
 </div>
 <div className="p-2 md:p-4 bg-white/5 rounded-lg md:rounded-xl">
 ...
 <p className="text-white text-center text-sm">Right Column</p>
 )}
 </div>
 </div>
 );
 ...
 <p className="text-white text-center text-sm">Middle Column</p>
 )}
 </div>
 <div className="p-2 md:p-4 bg-white/5 rounded-lg md:rounded-xl">
 {(block.rightBlocks || []).length > 0 ? (
...
const BlogPost = () => {
 ...
 <h1 className="text-4xl font-black  tracking-tighter mb-6">Article Not Found</h1>
 <button onClick={() => navigate('/blog')} className="text-primary font-black  tracking-widest text-sm flex items-center gap-2">
 ...
 <Link to="/blog" className="text-primary font-bold  tracking-wider text-sm hover:underline">
 Blog
 </Link>
 <span className="text-white">/</span>
 <span className="text-white font-medium  tracking-wider text-sm">{blog.category}</span>
 </div>

 {/* Title */}
 <h1 className="text-4xl md:text-6xl font-black  tracking-tight leading-[0.9] mb-8 text-white">
 {blog.title}
 </h1>
 ...
 <BookOpen className="w-4 h-4 text-primary" />
 <h4 className="text-xs font-black  tracking-widest text-white">Contents</h4>
 </div>
 ...
 prose-headings:font-black prose-headings: prose-headings: prose-headings:tracking-tighter prose-headings:text-white
 ...
 prose-li:text-white prose-li:font-medium"
 ...
 <div>
 <p className="text-[10px] font-black  tracking-widest text-white">Written by</p>
 <p className="font-black  tracking-tight">{blog.author}</p>
 </div>
 </div>
 <div className="flex items-center gap-3">
 ...
 <h4 className="text-2xl font-black  tracking-tighter mb-4 relative z-10">Need a Boost?</h4>
 <p className="text-white font-bold mb-6 relative z-10">Fastest and safest way to level up your game.</p>
 <Link to="/" className="block bg-white text-black py-3 rounded-xl font-black  tracking-widest text-xs relative z-10 hover:scale-105 transition-all">
 Get Started
 </Link>
 </div>
 ...
 <h3 className="text-xs font-black  tracking-widest text-white mb-6 flex items-center gap-2">
