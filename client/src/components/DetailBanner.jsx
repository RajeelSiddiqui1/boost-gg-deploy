    ...
    <div className="relative z-10 w-full px-8 md:px-16 py-12">
      <div className="max-w-4xl space-y-8 text-center md:text-left">
        <div className="space-y-4">
          <span className="text-[11px] font-black  tracking-[0.4em] text-white">CAN'T FIND WHAT YOU NEED?</span>
          <h2 className="text-5xl md:text-7xl font-black text-white leading-[0.9] tracking-tighter ">
            Get <span className="text-white italic">personalized</span> offer
          </h2>
        </div>
        <p className="text-white text-base md:text-xl font-medium leading-relaxed max-w-xl mx-auto md:mx-0">
        ...
        <button 
          ...
          className="px-16 py-6 bg-primary hover:bg-[#bbf74d] text-black rounded-2xl font-black  tracking-widest text-xs transition-all hover:scale-110 active:scale-95 shadow-[0_0_50px_rgba(162,230,62,0.4)]"
        >
          Create custom order
        </button>
      </div>
