    ...
    return (
        <div className="space-y-16">
            <div className="space-y-6">
                <h2 className="text-[28px] font-bold text-white tracking-tight uppercase italic underline decoration-sky-purple decoration-4 underline-offset-8">Description</h2>
            ...
            <div className="pt-16 border-t border-white/5 space-y-12">
                <h3 className="text-2xl font-bold text-white uppercase italic">How it works?</h3>
                <div className="grid md:grid-cols-4 gap-8">
                    {[
                        ...
                        <div key={s.step} className="space-y-4">
                            <div className="text-3xl font-black italic text-white/10">{s.step}</div>
