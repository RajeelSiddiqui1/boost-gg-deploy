        ...
        <AdminLayout>
            <div className="space-y-8 relative">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    <div>
                        <h1 className="text-2xl font-black italic text-white uppercase tracking-tighter">Games & Services</h1>
                ...
                {games.length === 0 ? (
                    <div className="bg-[#0A0A0A] border border-white/5 rounded-[40px] p-20 text-center">
                        ...
                        <h3 className="text-xl font-black italic text-white/20 uppercase mb-8">No games found</h3>
                        <button
                            onClick={() => setShowForm(true)}
                                        ...
                                        <tr key={game._id} className={`group hover:bg-white/[0.02] transition-colors ${selectedIds.includes(game._id) ? 'bg-primary/5' : ''}`}>
                                            <td className="px-4 py-4 w-10">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    />
                                                    <span className="text-[10px] font-black italic text-white/20">{game.displayOrder}</span>
                                                </div>
                                            </td>
                                            <td className="px-4 py-4 min-w-[300px]">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className="min-w-0">
                                                        <div className="text-[13px] font-black italic uppercase text-white group-hover:text-primary transition-colors truncate">{game.title}</div>
