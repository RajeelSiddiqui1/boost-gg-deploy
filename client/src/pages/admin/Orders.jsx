...
const OrdersList = () => {
 ...
 {loading ? (
 <tr><td colSpan="5" className="px-8 py-20 text-center text-white/20 font-black animate-pulse">Scanning Chains...</td></tr>
 ) : filteredOrders.length === 0 ? (
 <tr><td colSpan="5" className="px-8 py-20 text-center text-white/20 font-black ">No active data sequences</td></tr>
 ) : (
 ...
 <td className="px-8 py-6">
 <p className="text-xs font-black uppercase text-white/80">{order.offer?.title || 'Custom Boost'}</p>
