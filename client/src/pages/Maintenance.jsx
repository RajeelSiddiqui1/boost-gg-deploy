...
const Maintenance = () => {
 ...
 <p className="text-white text-lg md:text-xl font-bold max-w-2xl leading-relaxed mb-12">
 We are currently upgrading our systems to provide you with an even better experience.
 Please check back shortly.
 </p>
 <div className="flex items-center gap-2 text-white text-[10px] font-black  tracking-[0.2em] border border-white/10 px-4 py-2 rounded-full">
