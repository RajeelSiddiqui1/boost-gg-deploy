                                ...
                                <div className="flex-1 space-y-1">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        ...
                                        {Object.entries(item.selectedOptions || {}).map(([key, val], i) => {
                                            ...
                                            return (
                                                <span key={i} className="text-[9px] font-bold text-white/40 border border-white/10 px-2 py-0.5 rounded-md max-w-[160px] truncate">
                                                    {displayVal}
                                                </span>
                                            );
                                        })}
                ...
                {cartItems.length > 0 && (
                    <div className="p-8 border-t border-white/10 bg-white/[0.01] space-y-6">
                        ...
                        <button
                            ...
                            className="w-full bg-primary hover:bg-[#722AEE] text-black py-5 rounded-[24px] font-black text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-3 transition-all active:scale-95 shadow-2xl shadow-primary/20 group/btn relative overflow-hidden"
                        >
                ...
                <div className="absolute inset-0 z-[300] flex items-center justify-center p-6 bg-black/60 backdrop-blur-md animate-fade-in">
                    <div className="bg-[#0D0D0D] border border-white/10 rounded-[40px] p-8 max-w-sm w-full shadow-[0_30px_60px_rgba(0,0,0,0.8)] space-y-8">
                        ...
                        <div className="text-center space-y-2">
                            <h3 className="text-2xl font-black text-white uppercase tracking-tight ">Clear Cart?</h3>
