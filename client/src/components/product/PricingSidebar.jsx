            ...
            <div className="rounded-[14.22px] bg-sky-purple-gradient p-[21.33px] shadow-sky-sidebar relative overflow-hidden group/sidebar animate-in fade-in slide-in-from-right-8 duration-700">
                ...
                <div className="mb-8 relative z-10">
                    <div className="flex items-baseline gap-3 mb-1">
                        <span className="text-4xl font-black italic text-white font-skycoach">{price} €</span>
                        {originalPrice && (
                            <span className="text-lg font-bold text-white/30 line-through italic decoration-red-500/50">{originalPrice} €</span>
                        )}
                    </div>
                    <div className="flex items-center gap-2">
                        <span className="text-[10px] font-black uppercase tracking-widest text-white/40 font-stolzl italic">excl. VAT</span>
                        {discount && (
                            <span className="px-2 py-0.5 bg-red-500 text-white text-[9px] font-black rounded uppercase italic tracking-wider">-{discount}% OFF</span>
                        )}
                    </div>
                </div>
                ...
                <div className="space-y-4 mb-8 relative z-10">
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex items-center bg-black/20 rounded-xl p-1.5 border border-white/5 group/qty hover:border-white/20 transition-all">
                            ...
                            > - </button>
                            <span className="flex-1 text-center font-black italic text-white text-lg">{quantity} units</span>
                            <button
                ...
                >
                    ...
                    <div className="flex items-center justify-center gap-3 relative z-10">
                        <span className="text-xl font-black italic uppercase tracking-tighter text-black">Buy now</span>
                ...
                <div className="mt-6 p-4 bg-white/5 rounded-xl border border-white/5 flex items-center justify-between group/cashback cursor-help relative z-10">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs font-black text-white italic">+{cashback} € Cashback</p>
                        </div>
                    </div>
