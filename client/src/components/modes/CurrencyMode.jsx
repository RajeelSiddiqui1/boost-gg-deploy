...
const CurrencyMode = () => {
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                    {games.map(game => (
                        <button
                            ...
                            className="group relative h-[320px] rounded-[40px] overflow-hidden border border-white/5 hover:border-primary/50 transition-all duration-700 hover:-translate-y-2 hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.7)]"
                        >
                            ...
                            <div className="absolute inset-0 p-10 flex flex-col justify-between">
                                <div className="flex justify-between items-start">
                                    ...
                                    <div className="w-16 h-16 p-3 bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 group-hover:border-primary/30 transition-all">
    ...
    return (
        <div className="max-w-[1600px] mx-auto px-6 py-12 animate-fade-in font-['Outfit']">
            {/* Main Header Row */}
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-8">
                <div className="flex items-center gap-8">
                    ...
                    <div className="space-y-1">
                        <div className="flex items-center gap-3">
                            <span className="px-3 py-1 bg-primary/10 border border-primary/20 rounded-lg text-[10px] font-black text-primary uppercase tracking-[0.2em]">Marketplace</span>
                            <div className="w-1 h-1 rounded-full bg-white/20"></div>
                            <span className="text-[10px] font-black text-white/40 uppercase tracking-[0.2em]">{selectedGame.name}</span>
                        </div>
                        <h1 className="text-[64px] md:text-[80px] font-black text-white uppercase italic tracking-tighter leading-[0.8] mb-2">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button className="flex items-center gap-3 px-8 py-4 bg-primary rounded-2xl text-[12px] font-black uppercase tracking-widest text-black hover:scale-[1.05] transition-all shadow-[0_20px_40px_rgba(162,230,62,0.2)]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-7 space-y-8">
                    <div className="relative rounded-[48px] overflow-hidden bg-black/40 border border-white/5 aspect-[16/9] md:aspect-[21/9]">
                        ...
                        <div className="absolute right-8 top-1/2 -translate-y-1/2 w-[240px] p-6 rounded-[32px] bg-black/80 backdrop-blur-2xl border border-white/10 z-30 shadow-2xl hidden md:block">
                            ...
                            <p className="text-[11px] font-bold text-white/80 leading-relaxed mb-4 italic">
                        ...
                        <div className="absolute bottom-8 left-8 space-y-1 z-20">
                            <h3 className="text-2xl font-black text-white uppercase italic">Flexible</h3>
                    ...
                    <div className="flex flex-wrap items-center gap-6 px-4">
                        {[
                            ...
                            <div key={i} className="flex items-center gap-2 opacity-40 hover:opacity-100 transition-all cursor-default">
                    ...
                    <div className="pt-8 space-y-8">
                        <div className="space-y-4">
                            <h2 className="text-4xl font-black text-white uppercase italic tracking-tighter">Description</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="p-8 rounded-[40px] bg-white/[0.02] border border-white/5 space-y-6">
                                <h4 className="text-xl font-black text-white uppercase italic">What you'll get:</h4>
                ...
                <div className="lg:col-span-5">
                    <div className="rounded-[48px] bg-[#0A0A0A] border border-white/10 overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)]">
                        <div className="flex flex-col">
                            ...
                            <div className="p-10 space-y-10">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center justify-between px-2">
                                        <div className="flex items-center gap-3">
                                            <label className="text-[11px] font-black uppercase tracking-[0.2em] text-white/40">Amount to purchase</label>
                                            {selectedListing && (
                                    ...
                                    <div className="relative group">
                                        <input
                                            ...
                                            className="w-full bg-white/[0.02] border border-white/5 rounded-[32px] py-8 px-10 text-4xl font-black text-white placeholder:text-white/10 outline-none focus:border-primary/40 focus:bg-white/[0.04] transition-all"
                                        />
                                        <div className="absolute right-10 top-1/2 -translate-y-1/2 flex flex-col items-end">
                                            ...
                                            <span className="text-[10px] font-medium text-white/20 uppercase tracking-widest">Units</span>
                                        </div>
                                    </div>
                                    <div className="px-4 space-y-6">
                                        <input 
                                            ...
                                            className="w-full h-2 bg-white/5 rounded-lg appearance-none cursor-pointer accent-primary hover:accent-primary/80 transition-all"
                                        />
                                        <div className="flex justify-between">
                                            {presetQuantities.map((q, i) => (
                                                <button 
                                                    ...
                                                    className={`text-[10px] font-black uppercase tracking-widest transition-colors ${quantity === q ? 'text-primary' : 'text-white/20 hover:text-white/40'}`}
                                                >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-3">
                                        <label className="text-[11px] font-black uppercase tracking-[0.2em] text-white/40 ml-2">Server</label>
                                        <div className="relative group">
                                            <select
                                                ...
                                                className="w-full bg-white/[0.02] border border-white/5 rounded-2xl py-5 px-6 text-sm text-white font-bold appearance-none cursor-pointer focus:border-primary/40 outline-none transition-all pr-12"
                                            >
                                                {listings.map(listing => (
                                                    <option key={listing._id} value={listing._id} className="bg-[#0A0A0A]">
                                                        {listing.region} - {listing.server} ({listing.pricePerUnit}/unit)
                                                    </option>
                                                ))}
                                            </select>
                                            <ChevronRight className="absolute right-5 top-1/2 -translate-y-1/2 w-4 h-4 text-white/20 rotate-90 pointer-events-none group-hover:text-primary transition-colors" />
                                        </div>
                                    </div>

                                    <div className="space-y-3">
                                        <label className="text-[11px] font-black uppercase tracking-[0.2em] text-white/40 ml-2">Platform</label>
                                        <div className="relative group">
                                            <div className="w-full bg-white/[0.02] border border-white/5 rounded-2xl py-5 px-6 text-sm text-white font-bold flex items-center justify-between cursor-pointer group-hover:border-white/10 transition-all">
                                                <span className="flex items-center gap-3"><Monitor className="w-4 h-4 text-primary" /> PC / All</span>
                            ...
                            {/* Checkout Pane */}
                            <div className="bg-white/[0.02] border-t border-white/5 p-10 space-y-10">
                                {/* Completion Speed */}
                                <div className="space-y-6">
                                    <h4 className="text-[11px] font-black text-white/40 uppercase tracking-[0.2em] ml-2">Delivery speed</h4>
                                        ...
                                        {[
                                            ...
                                            return (
                                                <button 
                                                    ...
                                                    className={`flex flex-col items-center gap-2 p-5 rounded-3xl border-2 transition-all relative group ${isActive ? 'border-primary bg-primary/5 shadow-[0_0_30px_rgba(162,230,62,0.1)]' : 'border-white/5 bg-white/[0.02] hover:border-white/20'}`}
                                                >
                                                    <span className={`text-[11px] font-black uppercase tracking-widest ${isActive ? 'text-primary' : 'text-white/40'}`}>{option.label}</span>
                                                    <span className="text-[10px] font-medium text-white/20">{option.desc}</span>
                                                    {option.surcharge > 0 && (
                                                        <span className="mt-1 text-[10px] font-black text-primary">+{displayPrice(surchargeAmount)}</span>
                                                    )}
                                                </button>
                                            );
                                        })}
                                ...
                                <div className="space-y-8 pt-4 border-t border-white/5">
                                    <div className="flex items-end justify-between">
                                        <div className="space-y-1">
                                            <span className="text-[11px] font-black text-white/20 uppercase tracking-[0.2em]">Total Amount</span>
                                            <div className="flex items-baseline gap-2">
                                                <div className={`text-6xl font-black text-white tracking-tighter ${calculating ? 'opacity-20 blur-sm' : ''}`}>
                                        ...
                                        <div className="flex flex-col items-end">
                                            <div className="px-3 py-1.5 bg-primary/10 border border-primary/20 rounded-lg mb-2">
                                                <span className="text-[10px] font-black text-primary uppercase tracking-widest">5% Cashback</span>
                                            </div>
                                            <span className="text-[10px] font-medium text-white/20 uppercase tracking-widest">Price match guaranteed</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        <div className="relative group">
                                            ...
                                            <input 
                                                ...
                                                className="w-full bg-white/5 border border-white/5 rounded-[24px] py-6 pl-16 pr-8 text-sm text-white placeholder:text-white/20 outline-none focus:border-primary/40 focus:bg-white/[0.08] transition-all"
                                            />
                                        </div>
                                        
                                        <button 
                                            onClick={handleAddToCart}
                                            className="w-full py-7 bg-primary rounded-[28px] text-black font-black uppercase tracking-[0.2em] text-[15px] hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-4 shadow-[0_30px_60px_-15px_rgba(162,230,62,0.4)] group"
                                        >
                                            Purchase Now
                    ...
                    {/* Support Button */}
                    <div className="mt-8 p-6 rounded-[32px] bg-white/[0.02] border border-white/5 flex items-center justify-between hover:bg-white/[0.04] transition-all cursor-pointer group">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="space-y-0.5">
                                ...
                                <p className="text-[10px] font-medium text-white/40 uppercase tracking-widest">Online now • 1m response</p>
                            </div>
                        </div>
            ...
            <div className="mt-32 space-y-32">
                ...
                <div className="space-y-12">
                    <div className="flex items-center justify-between">
                        <div className="space-y-2">
                            <h2 className="text-4xl md:text-5xl font-black text-white uppercase italic tracking-tighter">Recommended Games</h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {games.filter(g => g._id !== selectedGame?._id).slice(0, 4).map(game => (
                            <button 
                                key={game._id} 
                                onClick={() => setSelectedGame(game)} 
                                className="group relative h-[280px] rounded-[32px] overflow-hidden border border-white/5 hover:border-primary/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.5)]"
                            >
                                <div className="absolute inset-0">
                                    <img 
                                        src={getImageUrl(game.bgImage || game.image)} 
