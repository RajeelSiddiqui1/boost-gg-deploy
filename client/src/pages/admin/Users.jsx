...
const Users = () => {
 ...
 {loading ? (
 <tr><td colSpan="5" className="px-8 py-20 text-center text-white/20 font-black animate-pulse">Syncing Database...</td></tr>
 ) : filteredUsers.length === 0 ? (
 <tr><td colSpan="5" className="px-8 py-20 text-center text-white/20 font-black ">No matches found in Nexus</td></tr>
 ) : (
