...
const LayoutBlock = ({ block }) => {
    ...
    if (block.isNewWidget || block.settings) {
        ...
        switch (block.type) {
            case 'heading':
                const Tag = c.tag || 'h2';
                widgetHtml = <Tag style={{ color: c.color, textAlign: c.align, fontSize: c.size, margin: 0 }} className="font-black italic uppercase tracking-tight">{c.text}</Tag>;
                break;
            case 'text':
            ...
            case 'quote':
                widgetHtml = <blockquote style={{ borderLeftColor: c.borderColor }} className="border-l-4 pl-6 py-2 my-4 bg-white/5 rounded-r-lg">
                    <p style={{ color: c.color }} className="text-xl md:text-2xl italic font-medium leading-relaxed">"{c.text}"</p>
        ...
        case 'image':
            ...
            return (
                <div className="my-6 md:my-8 w-full overflow-hidden">
                    ...
                    />
                    {block.caption && (
                        <p className="text-white/50 text-center mt-2 md:mt-3 text-xs md:text-sm font-medium italic px-2">
                            {block.caption}
                        </p>
                    )}
                </div>
        ...
        case 'quote':
            return (
                <blockquote className="border-l-2 md:border-l-4 border-primary pl-4 md:pl-6 my-6 md:my-8 py-1">
                    <p className="text-lg md:text-xl font-medium italic text-white/80 mb-2 md:mb-3 leading-relaxed">
                        "{block.content}"
                    </p>
                    {block.author && (
    ...
    if (!blog) {
        return (
            <div className="min-h-screen bg-black flex flex-col items-center justify-center">
                <h1 className="text-4xl font-black italic uppercase tracking-tighter mb-6">Article Not Found</h1>
            ...
            <section className="relative h-[50vh] min-h-[400px] overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12">
                    <div className="max-w-5xl mx-auto">
                        ...
                        {/* Title */}
                        <h1 className="text-4xl md:text-6xl font-black italic uppercase tracking-tight leading-[0.9] mb-8 text-white">
                            {blog.title}
                        </h1>
                ...
                <div className="flex flex-col xl:flex-row gap-8">
                        ...
                        <div className="mt-16 pt-12 border-t border-white/5 flex flex-wrap items-center justify-between gap-8">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="font-black italic uppercase tracking-tight">{blog.author}</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3">
                    ...
                    <aside className="w-full xl:w-80 flex-shrink-0 space-y-8">
                        ...
                        <div className="bg-primary rounded-2xl p-8 text-center relative overflow-hidden group">
                            ...
                            <h4 className="text-2xl font-black italic uppercase tracking-tighter mb-4 relative z-10">Need a Boost?</h4>
