            ...
            <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="mt-auto pt-6 border-t border-white/[0.05] flex items-center justify-between gap-4">
                    <div className="flex flex-col">
                        ...
                        <span className="text-2xl font-black text-white tracking-tighter italic">{formatPrice(account.price)}</span>
                    </div>
                    <button 
                        ...
                        {isAccountMode ? (
                            filteredAccounts.length > 0 ? (
                                ...
                                <div className="py-24 flex flex-col items-center justify-center bg-white/[0.01] border border-dashed border-white/10 rounded-[3rem]">
                                    ...
                                    <h3 className="text-xl font-black text-white uppercase italic tracking-tight mb-2">No Accounts Found</h3>
