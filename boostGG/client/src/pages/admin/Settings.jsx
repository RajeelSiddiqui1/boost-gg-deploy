        ...
        <AdminLayout>
            <div className="space-y-8 max-w-5xl mx-auto">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-black italic uppercase tracking-tighter text-white">System Settings</h1>
                        ...
                        <div className="space-y-8">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        ...
                                        <div className="space-y-4 p-6 bg-white/[0.02] border border-white/5 rounded-3xl">
                                            ...
                                            <input
                                                ...
                                                placeholder="USD"
                                            />
                                            <p className="text-[10px] text-white/20 font-bold italic uppercase">All product prices in database are assumed to be in this currency.</p>
                                        </div>
                            ...
                            {activeTab === 'security' && (
                                <div className="mt-8 pt-8 border-t border-white/5">
                                    <h3 className="text-lg font-black italic uppercase tracking-tight text-white mb-6">Admin Password</h3>
