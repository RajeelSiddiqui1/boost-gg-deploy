...
const BecomePro = () => {
 ...
 icon: DollarSign,
 color: 'from-[#00FF85] to-[#00FF85]/50'
 },
 {
 id: 'account_seller',
 ...
 icon: Layout,
 color: 'from-[#A8FF00] to-[#A8FF00]/50'
 },
 {
 id: 'content_creator',
 ...
 icon: Share2,
 color: 'from-[#04C108] to-[#04C108]/50'
 },
 {
 id: 'blogger',
 title: 'Blogger',
 ...
 icon: Edit3,
 color: 'from-[#17CC05] to-[#17CC05]/50'
 }
 ];
 ...
 {/* Background elements */}
 <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-primary/10 blur-[200px] rounded-full translate-x-1/3 -translate-y-1/3 pointer-events-none"></div>
 <div className="absolute bottom-0 left-0 w-[800px] h-[800px] bg-[#00FF85]/5 blur-[200px] rounded-full -translate-x-1/3 translate-y-1/3 pointer-events-none"></div>

 <div className="max-w-[1400px] mx-auto px-6 relative z-10">
 {/* Hero Section */}
 <div className="text-center mb-32 space-y-6">
 <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-primary text-[10px] font-black uppercase tracking-[0.2em] animate-pulse">
 <Globe className="w-4 h-4" />
 Join the Global Elite
 </div>
 <h1 className="text-8xl font-black leading-[0.8] uppercase tracking-tighter">
 Become a <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-[#00FF85]">PRO</span> <br />
 ...
 <h3 className="text-2xl font-black uppercase mb-1 tracking-tighter">{role.title}</h3>
 ...
 <h2 className="text-5xl font-black uppercase tracking-tighter">Why join BoostGG?</h2>
 ...
 <h4 className="text-xl font-black uppercase tracking-tighter text-white/90">{benefit.title}</h4>
 ...
 {/* Highlights Card */}
 <div className="p-10 bg-gradient-to-br from-[#0E2F0A] to-[#04C108] rounded-[48px] text-white shadow-[0_20px_50px_rgba(4,193,8,0.2)] relative overflow-hidden group border border-primary/20">
 <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 blur-[100px] rounded-full translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
 <div className="relative z-10 space-y-10">
 <div className="space-y-2">
 <h3 className="text-5xl font-black uppercase tracking-tighter leading-none">The #1 Platform</h3>
 ...
 <div className="w-10 h-10 rounded-full bg-primary/20 flex items-center justify-center font-black text-primary text-xs">{(t.name[1] || 'U').toUpperCase()}</div>
 <div>
 ...
 <p className="text-white/30 text-xs font-bold uppercase tracking-widest leading-relaxed ">"{t.text}"</p>
 </div>
 ))}
 </div>
 </div>
 ...
 <h3 className="text-5xl font-black uppercase tracking-tighter mb-2">Submit Application</h3>
 ...
 <div className="text-[10px] font-bold text-white/10 uppercase tracking-widest py-2 px-2 ">
 ...
 <h2 className="text-5xl font-black uppercase tracking-tighter">Frequently Asked Questions</h2>
 ...
 <h4 className="text-lg font-black uppercase tracking-tighter mb-4 flex items-center justify-between group-hover:text-primary transition-colors">
