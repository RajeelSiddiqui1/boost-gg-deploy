...
const AdminGames = () => {
 ...
 <div>
 <h1 className="text-2xl font-black text-white  tracking-tighter">Games & Services</h1>
 <p className="text-white text-xs font-bold  tracking-widest leading-relaxed">Manage your marketplace inventory</p>
 </div>
 ...
 <h3 className="text-xl font-black text-white  mb-8">No games found</h3>
 <button
 onClick={() => setShowForm(true)}
 ...
 <th className="px-4 py-5 text-[10px] font-black  tracking-[0.2em] text-white/20">Game & Service</th>
 <th className="px-4 py-5 text-[10px] font-black  tracking-[0.2em] text-white/20">Offers</th>
 <th className="px-4 py-5 text-[10px] font-black  tracking-[0.2em] text-white/20 whitespace-nowrap">Status & Tags</th>
 ...
 />
 <span className="text-[10px] font-black text-white">{game.displayOrder}</span>
 </div>
 </td>
 ...
 <div className="text-[13px] font-black  text-white group-hover:text-white transition-colors truncate">{game.title}</div>
 <div className="text-[9px] font-bold text-white  tracking-widest truncate">{game.slug}</div>
 </div>
 </div>
 </td>
 <td className="px-4 py-4">
 <span className="inline-flex px-2 py-0.5 bg-white/5 rounded-md text-[10px] font-black text-white border border-white/5">
 ...
 <span className="text-[9px] font-black  tracking-widest">{game.status}</span>
 </div>
 ...
 <span className="text-[9px] font-black  tracking-widest">HOT</span>
 </div>
 ) : (
 <div className="flex items-center gap-1 px-2 py-1 bg-white/[0.03] border border-white/[0.05] text-white rounded-full">
 <span className="text-[9px] font-black  tracking-widest">Regular</span>
 </div>
 )}
 </div>
 </td>
