...
const Footer = () => {
 ...
 <a href="#" className="w-10 h-10 rounded-xl bg-white/[0.03] flex items-center justify-center text-white hover:text-white hover:bg-white/[0.08] transition-all">
 ...
 <ul className="space-y-3 text-white text-[13px] font-medium">
 ...
 <h5 className="text-white text-[13px] font-bold">+1 855 401 11 56</h5>
 <p className="text-white text-[13px] font-medium">support@boostgg.com</p>
 <p className="text-white text-[13px] font-medium">copyright@boostgg.com</p>
 </div>
 ...
 <span className="text-white font-black  text-[13px] tracking-normal">Chat with us</span>
