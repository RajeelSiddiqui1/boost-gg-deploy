            ...
            <div className="bg-[#0A0A0A] border border-white/10 w-full max-w-[1000px] h-full lg:h-auto lg:max-h-[90vh] rounded-[48px] overflow-hidden flex flex-col animate-in slide-in-from-bottom-8 duration-500">
                ...
                <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-10 space-y-12">
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-3">
                            ...
                            <h3 className="text-sm font-black italic uppercase tracking-widest text-white/60">Basic Information</h3>
                        </div>
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-3">
                            ...
                            <h3 className="text-sm font-black italic uppercase tracking-widest text-white/60">Pricing & Display</h3>
                        </div>
                    ...
                    <div className="p-8 bg-white/[0.02] border border-white/5 rounded-[32px] space-y-8">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-sm font-black italic uppercase tracking-widest text-white/60">Dynamic Calculator</h3>
                            </div>
                            <select
                ...
                <div className="p-8 border-t border-white/5 bg-white/[0.01] flex items-center justify-end gap-4 shrink-0">
                    <button
                        type="button"
                        onClick={onClose}
                        className="px-8 py-4 bg-white/5 hover:bg-white/10 rounded-2xl font-black uppercase italic tracking-widest text-xs transition-all"
                    >
                        Discard
                    </button>
                    <button
                        ...
                        disabled={loading}
                        className="px-10 py-4 bg-primary hover:bg-primary/90 text-white rounded-2xl font-black uppercase italic tracking-widest text-xs transition-all flex items-center gap-2 shadow-lg shadow-primary/20 disabled:opacity-50"
                    >
