...
const RelatedAccountCard = ({ account }) => {
    ...
    const handleAddToCart = (e) => {
        ...
        const cartItem = {
            ...
            price: account.price,
            quantity: 1,
            image: account.thumbnail || account.screenshots?.[0] || account.gameId?.icon,
            mode: 'accounts',
            selectedOptions: {
                rank: account.rank,
        ...
        >
            ...
            <div className="p-5 flex flex-col flex-grow">
                ...
                <div className="mt-auto pt-4 border-t border-white/[0.05] flex items-center justify-between">
                    <span className="text-lg font-black text-white tracking-tighter italic">{formatPrice(account.price)}</span>
                    <button 
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
                    ...
                    <div className="relative bg-[#111] border border-white/10 rounded-[2.5rem] p-10 max-w-md w-full text-center shadow-[0_30px_60px_rgba(0,0,0,0.8)] animate-fade-in">
                        ...
                        <div className="flex flex-col items-center gap-6 mb-8">
                            ...
                            <h2 className="text-4xl font-black uppercase tracking-tighter italic">Buy risk-free with BoostGG</h2>
                        ...
                        <button 
                            onClick={() => setIsVerifiedModalOpen(false)}
                            className="w-full py-4 bg-[#7c3aed] hover:bg-[#6d28d9] text-white font-black uppercase tracking-[0.2em] rounded-2xl hover:scale-105 transition-all shadow-xl shadow-purple-500/20"
                        >
                            Got it
                        </button>
                    </div>
                ...
                <div className="flex flex-col lg:flex-row gap-8 items-start">
                    ...
                    <div className="flex-1 w-full min-w-0 space-y-8">
                        ...
                        <div className="lg:hidden mb-6">
                            ...
                            <h1 className="text-3xl font-black uppercase tracking-tighter italic leading-none mb-4">{account.title}</h1>
                        </div>
                        ...
                        <div className="bg-white/[0.02] border border-white/5 rounded-[3rem] p-8 md:p-12 space-y-12">
                            ...
                            <section>
                                <h2 className="text-2xl font-black uppercase tracking-tighter italic mb-8 flex items-center gap-3">
                        ...
                        {/* FAQ Section */}
                        <div className="space-y-4">
                            <h2 className="text-2xl font-black uppercase tracking-tighter italic mb-6">Frequently Asked Questions</h2>
                            {[
                                ...
                                <div key={i} className="bg-white/[0.02] border border-white/5 rounded-2xl p-6">
                                    <h4 className="text-[11px] font-black uppercase tracking-widest text-primary mb-2 italic">Q: {faq.q}</h4>
                    ...
                    <aside className="w-full lg:w-[400px] lg:sticky lg:top-24 space-y-8">
                        ...
                        <div className="mb-6">
                            <h2 className="text-4xl font-black text-white uppercase tracking-tighter mb-6 italic">Fast checkout</h2>
                            <div className="grid grid-cols-3 gap-4">
                                {[
                                    { icon: Star, label: 'Delivery within 24h', color: 'text-yellow-400' },
                                    { icon: ShieldCheck, label: 'Account creds can be changed', color: 'text-[#a2e63e]' },
                        ...
                        <div className="bg-gradient-to-br from-[#7c3aed] to-[#6d28d9] rounded-[3rem] overflow-hidden shadow-[0_30px_60px_rgba(124,58,237,0.25)] border border-white/10">
                            <div className="p-8 space-y-8">
                                
                                {/* Lifetime Warranty Toggle */}
                                <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-4 flex items-center justify-between group cursor-pointer" onClick={() => setWarrantyEnabled(!warrantyEnabled)}>
                                    <div className="flex items-center gap-3">
                                        <div className={`w-5 h-5 rounded-md border-2 transition-all flex items-center justify-center ${warrantyEnabled ? 'bg-white border-white' : 'bg-transparent border-white/20 group-hover:border-white/40'}`}>
                                            {warrantyEnabled && <CheckCircle2 className="w-4 h-4 text-purple-600" />}
                                        </div>
                                ...
                                <div className="flex justify-between items-end">
                                    ...
                                    <div className="text-right">
                                        <div className="flex items-baseline justify-end gap-2">
                                            <span className="text-5xl font-black text-white tracking-tighter italic leading-none">{formatPrice(finalPrice)}</span>
                                        </div>
                                ...
                                <div className="space-y-4">
                                    <div className="relative group">
                                        <input 
                                            ...
                                            className="w-full bg-white/10 border border-white/20 rounded-2xl py-5 px-6 text-[11px] font-black uppercase tracking-widest text-white placeholder:text-white/40 outline-none focus:border-white/60 transition-all"
                                        />
                                    </div>

                                    <div className="flex items-center justify-center gap-3">
                                        <div className="px-3 py-1 bg-white/20 rounded-lg text-[10px] font-black text-white">{formatPrice(finalPrice * 0.01)}</div>
                                        <span className="text-[10px] font-black text-white/40 uppercase tracking-widest">cashback after purchase</span>
                                    </div>

                                    <button 
                                        onClick={handleBuyNow}
                                        className="w-full bg-[#a2e63e] hover:bg-[#b5f550] text-black font-black uppercase tracking-[0.2em] py-6 rounded-2xl transition-all shadow-[0_15px_30px_rgba(162,230,62,0.3)] flex items-center justify-center gap-3 active:scale-95 group"
                                    >
                        ...
                        <div className="flex items-center justify-between p-4 bg-white/[0.03] border border-white/5 rounded-[2rem]">
                            <div className="flex items-center gap-3">
                                <ShieldCheck className="w-8 h-8 text-[#a2e63e]" />
                                <div>
                                    <div className="text-[11px] font-black text-white leading-none">BOOSTGG</div>
                                    <div className="text-[8px] font-black text-[#a2e63e] leading-none uppercase tracking-widest mt-0.5">VERIFIED</div>
                                </div>
                            </div>
                            <button 
                ...
                {relatedAccounts.length > 0 && (
                    <div className="mt-32">
                        <div className="flex items-end justify-between mb-12">
                            <div>
                                <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter italic leading-none mb-4">You May <span className="text-primary">Also Like</span></h2>
