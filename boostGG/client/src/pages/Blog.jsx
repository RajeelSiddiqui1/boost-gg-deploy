        ...
        <div className="min-h-screen bg-black text-white font-['Outfit'] selection:bg-primary/30">
            <div className="max-w-[1500px] mx-auto px-6 pt-32 pb-24">
                ...
                <div className="mb-12">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black italic tracking-tighter uppercase mb-2">Welcome to our Blog</h1>
                            ...
                            featuredBlogs.map((blog) => (
                                ...
                                >
                                    ...
                                    <div className="absolute bottom-4 left-4 right-4">
                                        ...
                                        <h3 className="text-[11px] font-black italic uppercase leading-tight line-clamp-2 tracking-tighter">{blog.title}</h3>
                                    </div>
                                </Link>
                            ))
                        )}
                    ...
                    <div className="flex-1">
                                ...
                                blogs.map((blog) => (
                                    ...
                                    >
                                        ...
                                        <div className="p-8 pb-10 flex-1 flex flex-col">
                                            ...
                                            <h3 className="text-2xl font-black italic uppercase tracking-tighter leading-tight mb-4 group-hover:text-primary transition-colors">{blog.title}</h3>
                                            <p className="text-white/40 text-sm font-bold leading-relaxed line-clamp-3 italic mb-8">
                        ...
                        {!loading && blogs.length === 0 && (
                            <div className="text-center py-24 bg-white/2 rounded-[40px] border border-dashed border-white/10">
                                ...
                                <h3 className="text-2xl font-black italic uppercase italic tracking-tighter">No articles found</h3>
                                <p className="text-white/40 font-bold mt-2 italic">Try adjusting your search or category filter</p>
                            </div>
                        )}
                    </div>
                    ...
                    <aside className="w-full lg:w-[350px] space-y-8">
                        ...
                        <div className="relative rounded-[32px] overflow-hidden group aspect-[4/5] md:aspect-auto md:h-64 lg:h-80">
                            ...
                            <div className="absolute bottom-8 left-8 right-8 text-center md:text-left">
                                <h4 className="text-2xl font-black italic uppercase italic tracking-tighter mb-4">Start your boost today</h4>
