...
const AdminBlogs = () => {
 ...
 <div>
 <h1 className="text-2xl font-black text-white uppercase tracking-tighter">Blog Management</h1>
 ...
 className="w-full md:w-auto flex items-center justify-center gap-2 bg-primary hover:bg-primary/90 text-white px-8 py-4 rounded-2xl font-black uppercase tracking-widest text-xs transition-all shadow-lg shadow-primary/20"
 >
 ...
 <h3 className="text-lg font-black uppercase tracking-tight text-white mb-4 line-clamp-2">{blog.title}</h3>
 ...
 <h3 className="text-2xl font-black uppercase tracking-tighter mb-4">No articles yet</h3>
 <p className="text-white/40 font-bold mb-8">Create your first article to get started</p>
 <button
 onClick={() => navigate('/admin/blogs/new')}
 className="inline-flex items-center gap-2 px-8 py-4 bg-primary hover:bg-primary/90 text-white rounded-2xl font-black uppercase tracking-widest text-xs transition-all"
 >
 <Plus className="w-4 h-4" />
 Create Article
 </button>
 ...
 <h3 className="text-2xl font-black uppercase tracking-tighter mb-4">Delete Article?</h3>
