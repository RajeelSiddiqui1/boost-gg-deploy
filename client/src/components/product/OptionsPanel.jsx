                ...
                <div className="space-y-8">
                                                ...
                                                <div className="flex items-center justify-between gap-4">
                                                    ...
                                                    {choice.addPrice > 0 && (
                                                        <div className="flex flex-col items-end">
                                                            <span className={`text-[11px] font-black italic tracking-tighter transition-colors ${isSelected ? "text-primary" : "text-white/20"}`}>
                                                                + {choice.addPrice} €
                                                            </span>
                                                        </div>
                                                    )}
                    ...
                    {serviceOptions.length === 0 && (
                        <div className="bg-white/[0.02] border border-white/5 border-dashed rounded-[28px] p-12 text-center">
                            <p className="text-white/20 text-[10px] font-black uppercase tracking-[0.2em] italic">No additional options available</p>
                        </div>
                    )}
                </div>
            )}
