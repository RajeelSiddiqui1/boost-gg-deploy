...
const Description = ({ title, content, requirements, whatYouGet }) => {
 ...
 <h2 className="text-[28px] font-bold text-white tracking-tight  underline decoration-sky-purple decoration-4 underline-offset-8">Description</h2>
 ...
 <h3 className="text-xl font-bold text-white  tracking-tight">What you'll get</h3>
 </div>
 ...
 <span className="flex-shrink-0 w-7 h-7 flex items-center justify-center rounded-lg bg-white/5 text-[10px] font-black text-white group-hover:bg-sky-purple/20 group-hover:text-white transition-all border border-white/5">
 ...
 <h3 className="text-xl font-bold text-white  tracking-tight">Requirements</h3>
 </div>
 ...
 <div className="text-3xl font-black text-white">{s.step}</div>
